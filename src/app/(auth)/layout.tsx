...
export default function AuthLayout({
    ...
    return (
        <div className="min-h-screen bg-gray-50 relative overflow-hidden">
            ...
            <div className="absolute top-0 right-0 w-[600px] h-[600px] bg-blue-100/40 rounded-full -mr-64 -mt-64 blur-3xl" />
            <div className="absolute bottom-0 left-0 w-[400px] h-[400px] bg-indigo-100/30 rounded-full -ml-48 -mb-48 blur-3xl" />
